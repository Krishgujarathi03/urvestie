  ...
  return (
    <section className="relative bg-black text-white py-16 overflow-hidden">
      ...
      <div className="w-full px-6 z-10 relative">
        ...
        <p className="text-[#FFFFFF] text-[32px] text-center max-w-6xl mx-auto">
          Runway. Street. Social.
          <br />
          From the latest runway looks to emerging street styles, <br />
        ...
        <div className="flex w-max animate-scroll gap-6">
          {[...images, ...images].map((src, index) => (
            <img
              ...
              src={src}
              alt={`Fashion ${index + 1}`}
              className="rounded-2xl w-64 h-80 object-cover"
            />
          ))}
        </div>
      </div>
