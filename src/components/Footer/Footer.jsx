    ...
    <footer className="bg-black text-white px-4 py-8 md:px-6 md:py-10">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-10">
        ...
        <div className="mb-6 md:mb-0">
          <h2 className="text-[28px] md:text-[40px] font mb-2">URVESTIE</h2>
          <p className="text-[16px] md:text-[24px] text-white mb-4">
            Fashion advice. Real stylists. Every budget.
          </p>
          <p className="text-[16px] md:text-[24px] text-white mt-6 md:mt-10">
          ...
          <div className="flex flex-col items-start">
            <div className="flex gap-4">
              <Link to="/" aria-label="Instagram">
                <Instagram className="w-8 h-8 md:w-[45px] md:h-[45px] text-white hover:text-gray-300" />
              </Link>
              <Link to="/" aria-label="LinkedIn">
                <Linkedin className="w-8 h-8 md:w-[45px] md:h-[45px] text-white hover:text-gray-300" />
              </Link>
              <Link to="/" aria-label="Pinterest">
                <svg
                  className="w-8 h-8 md:w-[45px] md:h-[45px] fill-current text-white hover:text-gray-300"
                  viewBox="0 0 24 24"
                >
